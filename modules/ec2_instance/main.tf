...
resource "aws_instance" "web_server" {
  ami           = var.ami_value
  instance_type = lookup(var.instance_type_value,terraform.workspace,"t2.micro") // This will lookup values as per workspace env, if not take the default value t2.micro 
